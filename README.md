...
*(Note: While we aligned the stages with the assignment requirements, it may be necessary to implement alternative strategies to create a more robust pipeline for the app, such as testing the Docker Image.)*
### Dockerfile
